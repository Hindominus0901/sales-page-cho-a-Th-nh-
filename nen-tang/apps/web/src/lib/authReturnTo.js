...
// Resolve ?returnTo= to a safe same-origin path, else the app home.
//
// Mac dinh PHAI la /dashboard chu khong phai "/": Worker phuc vu trang ban
// hang o "/", nen tra ve "/" la nem nguoi vua dang nhap ra trang ban hang.
//
...
export function safeReturnTo() {
  ...
  try {
    ...
    // "/" la trang ban hang, khong phai trang chu cua app.
    return path === "/" ? APP_HOME : path;
  } catch {
    return APP_HOME;
  }
}
